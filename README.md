# Set Timezone in Python Selenium Tests on TestMu AI (Formerly LambdaTest)
...
For the full list of available capabilities, you can refer to the TestMu AI (Formerly LambdaTest) documentation.
